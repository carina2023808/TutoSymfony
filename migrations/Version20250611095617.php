 ...
 */
final class Version20250611095617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE recipes RENAME INDEX title TO UNIQ_A369E2B52B36786B
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE recipes RENAME INDEX uniq_a369e2b52b36786b TO title
        SQL);
    }
}
